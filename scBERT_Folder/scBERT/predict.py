...
parser.add_argument("--data_path", type=str, default='Zheng68K.h5ad', help='Path of data for predicting.')
parser.add_argument("--model_path", type=str, default='finetune_best.pth', help='Path of finetuned model.')
...
with torch.no_grad():
    for index in range(batch_size):
        ...
        pred_finals.append(pred_final.cpu())
        if index % 1000 == 0:
            print("Processed cell {} of {}".format(index, batch_size))
pred_list = label_dict[pred_finals].tolist()
for index in novel_indices:
    pred_list[index] = 'Unassigned'

# open file in write mode
with open(r'/workspace/Predictions/CD4_Pred.txt', 'w') as fp:
